...
@Component({
  selector: 'app-salon-b',
  templateUrl: './salon-b.component.html',
  styleUrls: ['./salon-b.component.scss'],
})
export class SalonBComponent implements OnInit {

  coleccion = "mensajes-salon-b";
